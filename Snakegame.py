...
def print_board(snake,food):#here snake and food inside the fun
    for y in range(height):
        ...
        print()
    print()
def move_snake(snake, direction):#here snake and direction for moving snake
    head =snake[-1]
    if direction== 'up':
        ...
        print("invalid direction ,use l/r/u/d")
        return snake, False#here again snake will continue game
    #wall colide condition
